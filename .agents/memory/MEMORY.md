...
- [Coolify Docker Compose deployment](coolify-docker-compose-deployment.md) — Full checklist: slim not alpine, tsconfig copy, no port 80, Traefik labels, vite.config defaults
